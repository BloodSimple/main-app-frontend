...
export class MakeAppointmentComponent implements OnInit {
  ...
  search() {
    //Give user only medical center with free appointments
    ...
    this.medicalCenterService
      .getMedicalCenterWithAppointments(startDateTime)
  ...
  schedule(medicalCenterId: any, startTime: any, personalId: any) {
    this.appointment.medicalCenterId = medicalCenterId;
    this.appointment.startTime = startTime;
    this.appointment.user = this.user;

    this.userService
      .scheduleAppointment(medicalCenterId, startTime, personalId)
      .subscribe((appointment: any) => {
        ...
        if (
          ...
          appointment.response ==
          'You should take questionnaire before blood donation.'
        ) {
          Swal.fire({
            icon: 'error',
            title: 'Error',
          ...
          appointment.response == 'You should take questionnaire again...'
        ) {
          Swal.fire({
            icon: 'error',
            title: 'Error',
          ...
          appointment.response ==
          "You have cancelled this appointment, you can't schedule it again."
        ) {
          Swal.fire({
            icon: 'error',
            title: 'Error',
